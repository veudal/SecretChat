...
namespace SecretChat
{
    public partial class MainWindow : Window
    {
        ...
        //    var line = frame.GetFileLineNumber();
        //    crash = true;
        //    ErrorInfo = "Ein unbekannter Fehler ist aufgetreten, es tut uns Leid, es liegt nicht an Dir, sondern an uns, damit dies nicht wieder vorkommt sende den Fehler (er wurde in deine Zwischenablage gespeichert) an folgende Email-Adresse: ***REMOVED***. Secret Chat® wird nun automatisch beendet. Fehler:  " + e.Message + "  Line: " + line + " in " + frame + "              Der Fehler wurde in Deine Zwischenablage gespeichert.";
        //    //ErrorInfo = "Ein unbekannter Fehler ist aufgetreten, es tut uns Leid, sondern an uns, damit dies nicht wieder vorkommt sende den Fehler (er wurde in deine Zwischenablage gespeichert) an folgende Email-Adresse: ***REMOVED***. Secret Chat® wird nun automatisch beendet. Fehler:  " + e.Message + "  Line: " + line + " in " + frame + "              Der Fehler wurde in Deine Zwischenablage gespeichert.";
        //}
        //}
        ...
        private void Window_Initialized(object sender, EventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                var line = frame.GetFileLineNumber();
                crash = true;
                ErrorInfo = "Ein unbekannter Fehler ist aufgetreten, es tut uns Leid, es liegt nicht an Dir, sondern an uns, damit dies nicht wieder vorkommt sende den Fehler (er wurde in deine Zwischenablage gespeichert) an folgende Email-Adresse: ***REMOVED***. Secret Chat® wird nun automatisch beendet. Fehler:  " + ex.Message + "  Line: " + line + " in " + frame + "              Der Fehler wurde in Deine Zwischenablage gespeichert.";
                //ErrorInfo = "Ein unbekannter Fehler ist aufgetreten, es tut uns Leid, es liegt nicht an dir, sondern an uns, damit dies nicht wieder vorkommt sende den Fehler (er wurde in deine Zwischenablage gespeichert) an folgende Email-Adresse: ***REMOVED***. Secret Chat® wird nun automatisch beendet. Fehler:  " + e.Message + "  Line: " + line + " in " + frame + "              Der Fehler wurde in Deine Zwischenablage gespeichert.";
            }
        }
    }
